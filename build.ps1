...
& $taskCompiler /nologo /target:winexe /platform:x64 /optimize+ /codepage:65001 "/win32manifest:$PSScriptRoot\app.manifest" /reference:System.Windows.Forms.dll /reference:System.Drawing.dll /reference:System.Web.Extensions.dll /reference:System.Security.dll "/reference:$taskLib" "/resource:$taskLib,YamlDotNet.dll" "/resource:$taskProbe,ClashGuardProbe.exe" "/out:$OutputPath" (Join-Path $PSScriptRoot 'App.cs') (Join-Path $PSScriptRoot 'Core.cs') (Join-Path $PSScriptRoot 'Guard.cs') (Join-Path $PSScriptRoot 'Tests.cs') (Join-Path $PSScriptRoot 'Memory.cs')
